...
public class GameManager : MonoBehaviour
{
    ...
    {
        if (popupPanel.activeSelf) return;   // 🔒 block input
    ...
    void ResolveToss()
    {
        ...
        if (playerWinsToss)
        {
            ...
            tossPanel.SetActive(true); // wait for choice
        }
        else
        {
            playerBatting = false;
            ...
            Invoke(nameof(StartInnings), 1.5f); // small pause ✔
        }
    }
    ...
    void HandleBackButton()
    {
        ...
        // 2️⃣ If match ended → go to Main Menu
        ...
        // 3️⃣ If match running → confirm quit
